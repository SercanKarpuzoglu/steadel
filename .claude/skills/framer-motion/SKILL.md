...
---
Source: github.com/dylantarre/animation-principles (skills/09-by-tool-framework/framer-motion), MIT-licensed marketplace; content reviewed 2026-07-13.
Steadel note: apply sparingly — brand tone is "calm, steady". Prefer principles 6 (slow in/out), 9 (timing) and subtle 12 (appeal); avoid 10 (exaggeration) on core UI.
